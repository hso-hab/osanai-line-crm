...
$('#reset').onclick=()=>{if(!confirm('このブラウザのデモ顧客・取引・変更履歴を消して、最初のサンプルに戻しますか？'))return;if(persist(seed())){reportAnchor=F.today();$('#report-date').value=reportAnchor;setView('all');notify('デモを最初の状態に戻しました。')}};
