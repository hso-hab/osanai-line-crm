...
(()=>{
 ...
 const definitions={cases:['案件管理','申込・審査・買取・入金を管理します。','manual-details','cases-nav'],recovery:['回収管理','期日が近い案件と延滞の確認・入金記録。','mg-recovery-section','recovery-nav'],reports:['売上分析','前月比較・今年累計・顧客別・担当者別の実績。','mg-report-section','reports-nav'],sales:['売上・回収ダッシュボード','今月の数字と、今日の対応を確認。','mg-dashboard','ops-nav'],customers:['顧客一覧・手動管理','顧客の対応状況、申込案件、入金を管理します。','manual-details','all'],today:['今日の対応','今日までに対応が必要なお客様を確認します。','manual-details','due'],analytics:['審査・弁済分析','審査結果と回収状況を、顧客・金額帯ごとに確認します。','analytics-details','fc-nav'],ledger:['旧売上台帳','以前の手入力売上・利益を確認します。案件集計とは別の台帳です。','legacy-details','sales-nav'],notices:['通知・責任者確認','受領した通知の記録と、人による確認を管理します。','notices-details','notice-nav'],tools:['業務ツール','使いたい機能を選ぶと、専用ページへ移動します。','wb-tools','wb-nav'],documents:['書類・契約管理','案件ごとの提出書類、契約の進捗、先払い予定を管理します。','wb-documents','wb-nav'],bank:['入金照合','CSVの入金明細と案件を、人が確認して照合します。','wb-bank','wb-nav'],cash:['資金繰り予定','現在残高と先払い・回収予定から、31日分を試算します。','wb-cash','wb-nav'],reminders:['期限・対応漏れ','期限が今日以前の未完了項目を確認します。','wb-reminders','wb-nav'],jobs:['AI・手動引継ぎ','担当・期限・対応結果を記録します。AIの実監視は未接続です。','wb-jobs','wb-nav'],acquisition:['集客分析','流入経路ごとの申込・契約・買取と広告費を確認します。','wb-acquisition','wb-nav'],backup:['保存・バックアップ','データの保存・復元と、誤操作防止ロックを設定します。','wb-backup','wb-nav']};
